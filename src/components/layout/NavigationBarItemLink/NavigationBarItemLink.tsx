    ...
    <ReactNavigatioMenuItem>
      <Link href={href} passHref legacyBehavior>
        <ReactNavigatioMenuLink
          active={active}
          className="font-medium leading-6 text-sm py-1 px-3 flex space-x-3 whitespace-nowrap overflow-ellipsis rounded-md text-dark-shades hover:bg-light-shades data-[active]:bg-light-shades data-[active]:text-main"
        >
          {children}
        </ReactNavigatioMenuLink>
      </Link>
